...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("quant_q_buffer") = std::nullopt, nb::arg("quant_k_buffer") = std::nullopt,
        nb::arg("quant_v_buffer") = std::nullopt, nb::arg("flash_mla_tile_scheduler_metadata") = std::nullopt,
