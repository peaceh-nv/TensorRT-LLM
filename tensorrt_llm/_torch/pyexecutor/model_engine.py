    ...
    def create_weights(self, prefix, weights: Dict):
        ...
        for k, v in weights.items():
            if k.startswith(prefix):
                ...
                new_scale_shape[1] = new_scale_shape[1] // 8
        result[prefix] = torch.ones(new_shape, dtype=torch.uint8)
        result[prefix + '.weght_scale'] = torch.ones(new_scale_shape,
