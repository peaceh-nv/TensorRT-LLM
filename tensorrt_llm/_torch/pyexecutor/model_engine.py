...
class PyTorchModelEngine(ModelEngine):
    ...
    def _prepare_tp_inputs(
        ...
        for request in extend_requests:
            if next_draft_tokens_device is None or request.py_batch_idx is None or request.is_dummy:
                ...
                # (3) request.is_dummy, which means the request is a dummy generation request created
                # for CUDA graph padding or attention DP. These dummy generation requests should be at
                # the end of generation_requests.
